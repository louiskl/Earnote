...
| **P2 – teilweise ✅ 25.09.2026** | ✅ Menüleiste und Tastenkürzel wie am Mac (`PhoneCommands`: ⇧⌘R Aufnahme, ⇧⌘P Pause, ⌘O Import, ⌘, Einstellungen, ⌘F Suche; über `focusedSceneValue` je Fenster) · ✅ Audiodateien ins Fenster ziehen · offen: mehrere Fenster (Notiz im eigenen Fenster), Transkript als Inspector | Fühlt sich an wie eine iPad-App |
