...
1. **Modelle laden** (einmalig): Whisper von Hugging Face, das lokale Sprachmodell von Hugging Face, mit eingeschalteter Sprechererkennung (am iPhone/iPad Earnote Pro) deren Modelle (FluidInference, einige MB). Die Stimmen werden auf dem Gerät unterschieden, nichts davon verlässt es.
