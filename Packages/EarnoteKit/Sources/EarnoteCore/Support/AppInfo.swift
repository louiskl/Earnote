...
public enum AppInfo {
    ...
    /// Freiwillig unterstützen – die App bleibt kostenlos. Ko-fi, weil dort ohne Konto per PayPal oder Karte geht
    public static let sponsor = URL(string: "https://ko-fi.com/louiskl")!
