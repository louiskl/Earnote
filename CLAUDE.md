...
- iPhone-App (Plan: [docs/IPHONE.md](docs/IPHONE.md), Oberfläche: DESIGN_GUIDELINES Abschnitt 30): eigenes Projekt `EarnoteiOS.xcodeproj` aus dem Ordner `EarnoteiOS/` (dazu die Erweiterungen `EarnoteWidgets/` und `EarnoteShare/`), damit Mac-App und Release-Weg unberührt bleiben.
